    ...
    **/
    function process () {
        ...
        //if (false) {
                ...
                if ($this->txt_watermark!='' ) {
                    imagestring ( $this->img["des"], $this->txt_watermark_font, $this->calc_text_position_H() , $this->calc_text_position_V(), html_entity_decode($this->txt_watermark,ENT_QUOTES),$txt_color);
                }
        } else {
